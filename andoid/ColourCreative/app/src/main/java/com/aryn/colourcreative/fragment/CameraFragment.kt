...
package com.aryn.colourcreative.fragment
...
import com.aryn.colourcreative.*
import com.aryn.colourcreative.util.CompareSizesByArea
import com.aryn.colourcreative.util.ImageSaver
import java.io.File
...
class CameraFragment : Fragment(), View.OnClickListener,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        file = File(activity?.getExternalFilesDir(null), IMAGE_FILENAME)
    }
        ...
        try {
            ...
            val captureBuilder = cameraDevice?.createCaptureRequest(
                ...
                set(CaptureRequest.JPEG_ORIENTATION,
                        (rotation?.let { ORIENTATIONS.get(it) }!! + sensorOrientation + 270) % 360)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.fullscreen_view -> lockFocus()
